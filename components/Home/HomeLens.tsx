      ...
      <section className="bg-[var(--background)] border-b border-dashed border-[var(--outline)]">
        <div className="max-w-3xl mx-auto flex flex-col items-start p-6 border-x border-dashed border-[var(--outline)]">
          ...
          <div className="p-4 grid grid-cols-3 gap-4 w-full">
            ...
            <Image className="w-full aspect-[3/4] object-cover rounded-lg" src="/images/lens/img_1.avif" alt="Mountains at Flagstaff" width={500} height={500} />
            <Image className="w-full aspect-[3/4] object-cover rounded-lg" src="/images/lens/img_2.avif" alt="Dinky on the porch" width={500} height={500} />
            <Image className="w-full aspect-[3/4] object-cover rounded-lg" src="/images/lens/img_3.avif" alt="HackLab presentation rehearsal" width={500} height={500} />
          </div>
